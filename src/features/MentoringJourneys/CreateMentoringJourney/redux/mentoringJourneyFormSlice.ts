...
export const mentoringJourneyFormSlice = createSlice({
  ...
  reducers: {
    ...
    setMinDeadlineDate: (state: MentoringJourneyFormState, action: PayloadAction<Date>) => {
      state.milestones.minDeadlineDate = action.payload
    },
    setMaxDeadlineDate: (state: MentoringJourneyFormState, action: PayloadAction<Date>) => {
