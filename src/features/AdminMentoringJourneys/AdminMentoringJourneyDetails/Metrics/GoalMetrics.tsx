  ...
  return (
    <Flex flexDir="column">
      ...
      <Flex justifyContent="center" mt="10">
        ...
        <iframe width="600" height="450" title="Goals Dashboard" src="https://lookerstudio.google.com/embed/reporting/33f17403-52fa-4e85-8cb3-a1db82f54f52/page/X8esD" style={{ border: '0' }} allowFullScreen sandbox="allow-storage-access-by-user-activation allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox" />
      </Flex>
    </Flex>
  )
}
